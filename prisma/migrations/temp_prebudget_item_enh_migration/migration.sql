...
-- CreateEnum
CREATE TYPE "VisitaStatus" AS ENUM ('PLANNED', 'COMPLETED', 'CANCELLED', 'RESCHEDULED');

-- CreateEnum
CREATE TYPE "ProductModelType" AS ENUM ('CORTINA', 'PERSIANA', 'PAPEL_DE_PAREDE', 'SERVICO', 'OUTRO');
...
CREATE TABLE "Product" (
    ...
    "modelType" "ProductModelType" NOT NULL DEFAULT 'OUTRO',
    "preBudgetItemSchemaJson" JSONB,
    "tenantId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "PreBudgetItem" (
    "id" TEXT NOT NULL,
    "preBudgetId" TEXT NOT NULL,
    "productId" TEXT,
    "customDescription" TEXT,
    "quantity" INTEGER NOT NULL DEFAULT 1,
    "customInputsJson" JSONB,
    "notes" TEXT,
    ...
    CONSTRAINT "PreBudgetItem_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Visita" (
    ...
    "notes" TEXT,
    "status" "VisitaStatus" NOT NULL DEFAULT 'PLANNED',
...
-- AddForeignKey
ALTER TABLE "PreBudgetItem" ADD CONSTRAINT "PreBudgetItem_preBudgetId_fkey" FOREIGN KEY ("preBudgetId") REFERENCES "PreBudget"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PreBudgetItem" ADD CONSTRAINT "PreBudgetItem_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PreBudgetItem" ADD CONSTRAINT "PreBudgetItem_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Activity" ADD CONSTRAINT "Activity_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Visita" ADD CONSTRAINT "Visita_assignedToUserId_fkey" FOREIGN KEY ("assignedToUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Visita" ADD CONSTRAINT "Visita_clientProfileId_fkey" FOREIGN KEY ("clientProfileId") REFERENCES "ClientProfile"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Visita" ADD CONSTRAINT "Visita_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
